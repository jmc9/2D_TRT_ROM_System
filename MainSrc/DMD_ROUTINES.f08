...
!
!==================================================================================================================================!
SUBROUTINE DMD_RECONSTRUCT(dat, L, B, W, rank, len, N_g, DMDgsum, Time, Open_Threads)
...
SUBROUTINE DMD_RECONSTRUCT_fg(fg_avg_xx, fg_avg_yy, fg_edgV_xx, fg_edgV_xy, fg_edgH_yy, fg_edgH_xy,&
  ...
  CALL DMD_RECONSTRUCT(f, L_fg_edgV_xx, B_fg_edgV_xx, W_fg_edgV_xx, rrank_fg_edgV_xx, len, N_g, DMDgsum, Time, Open_Threads)
  ...
  CALL DMD_RECONSTRUCT(f, L_fg_edgV_xy, B_fg_edgV_xy, W_fg_edgV_xy, rrank_fg_edgV_xy, len, N_g, DMDgsum, Time, Open_Threads)
  ...
  CALL DMD_RECONSTRUCT(f, L_fg_edgH_yy, B_fg_edgH_yy, W_fg_edgH_yy, rrank_fg_edgH_yy, len, N_g, DMDgsum, Time, Open_Threads)
  ...
  CALL DMD_RECONSTRUCT(f, L_fg_edgH_xy, B_fg_edgH_xy, W_fg_edgH_xy, rrank_fg_edgH_xy, len, N_g, DMDgsum, Time, Open_Threads)
  ...
  CALL DMD_RECONSTRUCT(f, L_fg_avg_xx, B_fg_avg_xx, W_fg_avg_xx, rrank_fg_avg_xx, len, N_g, DMDgsum, Time, Open_Threads)
  ...
  CALL DMD_RECONSTRUCT(f, L_fg_avg_yy, B_fg_avg_yy, W_fg_avg_yy, rrank_fg_avg_yy, len, N_g, DMDgsum, Time, Open_Threads)
...
!
!==================================================================================================================================!
SUBROUTINE DMD_RECONSTRUCT_BCg(Cg_L, Cg_B, Cg_R, Cg_T, L_BCg, B_BCg, W_BCg, rrank_BCg, dN_x, dN_y, dN_g, N_x, N_y, N_g,&
  ...
  CALL DMD_RECONSTRUCT(BC, L_BCg, B_BCg, W_BCg, rrank_BCg, len, N_g, DMDgsum, Time, Open_Threads)
...
!
!==================================================================================================================================!
SUBROUTINE INPUT_fg_DMD(Fname, DMDgsum, N_x, N_y, N_g, L_BCg, W_BCg, B_BCg, rrank_BCg, L_fg_avg_xx, W_fg_avg_xx,&
  B_fg_avg_xx, rrank_fg_avg_xx, L_fg_edgV_xx, W_fg_edgV_xx, B_fg_edgV_xx, rrank_fg_edgV_xx, L_fg_avg_yy,&
  W_fg_avg_yy, B_fg_avg_yy, rrank_fg_avg_yy, L_fg_edgH_yy, W_fg_edgH_yy, B_fg_edgH_yy, rrank_fg_edgH_yy,&
  L_fg_edgV_xy, W_fg_edgV_xy, B_fg_edgV_xy, rrank_fg_edgV_xy, L_fg_edgH_xy, W_fg_edgH_xy, B_fg_edgH_xy,&
  rrank_fg_edgH_xy, xlen, ylen, Tini, Delx, Dely, bcT, BC_Type, Start_Time)
  ...
  clen = 2*(N_x+N_y)
  CALL READ_DMD(ncID, 'BCg', DMDgsum, clen, N_g, L_BCg, W_BCg, B_BCg, rrank_BCg)

  clen = N_x*N_y
  CALL READ_DMD(ncID, 'fg_avg_xx', DMDgsum, clen, N_g, L_fg_avg_xx, W_fg_avg_xx, B_fg_avg_xx, rrank_fg_avg_xx)

  clen = (N_x+1)*N_y
  CALL READ_DMD(ncID, 'fg_edgV_xx', DMDgsum, clen, N_g, L_fg_edgV_xx, W_fg_edgV_xx, B_fg_edgV_xx, rrank_fg_edgV_xx)

  clen = N_x*N_y
  CALL READ_DMD(ncID, 'fg_avg_yy', DMDgsum, clen, N_g, L_fg_avg_yy, W_fg_avg_yy, B_fg_avg_yy, rrank_fg_avg_yy)

  clen = N_x*(N_y+1)
  CALL READ_DMD(ncID, 'fg_edgH_yy', DMDgsum, clen, N_g, L_fg_edgH_yy, W_fg_edgH_yy, B_fg_edgH_yy, rrank_fg_edgH_yy)

  clen = (N_x+1)*N_y
  CALL READ_DMD(ncID, 'fg_edgV_xy', DMDgsum, clen, N_g, L_fg_edgV_xy, W_fg_edgV_xy, B_fg_edgV_xy, rrank_fg_edgV_xy)

  clen = N_x*(N_y+1)
  CALL READ_DMD(ncID, 'fg_edgH_xy', DMDgsum, clen, N_g, L_fg_edgH_xy, W_fg_edgH_xy, B_fg_edgH_xy, rrank_fg_edgH_xy)
...
!
!==================================================================================================================================!
SUBROUTINE READ_DMD(ncID, name, DMDgsum, clen, N_g, L, W, B, N_modes)
