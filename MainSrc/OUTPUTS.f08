...
!
!==================================================================================================================================!
SUBROUTINE OUTFILE_INIT(outID,N_x_ID,N_y_ID,N_m_ID,N_g_ID,N_t_ID,N_edgV_ID,N_edgH_ID,RT_Its_ID,MGQD_Its_ID,GQD_Its_ID,&
  ...
  database_gen,use_grey,maxit_RTE,maxit_MLOQD,maxit_GLOQD,conv_type,threads,BC_type,outfile,run_type,kapE_dT,quad,enrgy_strc)

  INTEGER,INTENT(OUT):: outID
  INTEGER,INTENT(OUT):: N_x_ID, N_y_ID, N_m_ID, N_g_ID, N_t_ID, N_edgV_ID, N_edgH_ID
  INTEGER,INTENT(OUT):: RT_Its_ID, MGQD_Its_ID, GQD_Its_ID, Norm_Types_ID, Boundaries_ID
  ...
  CALL NF_DEF_DIM(Norm_Types_ID,outID,'Norm_Types',6) !inf (rel/abs), 2 (rel/abs), 1 (rel,abs)
...
!
!==================================================================================================================================!
SUBROUTINE OUTFILE_VARDEFS(outID,N_x_ID,N_y_ID,N_m_ID,N_g_ID,N_t_ID,N_edgV_ID,N_edgH_ID,RT_Its_ID,MGQD_Its_ID,GQD_Its_ID,&
  ...
  INTEGER,INTENT(OUT):: RT_Residual_ID, RT_ResNorms_ID, MGQD_Residual_ID, MGQD_ResNorms_ID
  ...
  !                                                                           !
  !===========================================================================!
  CALL NF_DEF_VAR(RT_Residual_ID,outID,(/N_x_ID,N_y_ID,N_m_ID,N_g_ID,RT_Its_ID,N_t_ID/),'RT_Residual','Double')
  CALL NF_DEF_VAR(RT_ResNorms_ID,outID,(/Norm_Types_ID,N_m_ID,N_g_ID,RT_Its_ID,N_t_ID/),'RT_ResNorms','Double')

  CALL NF_DEF_VAR(MGQD_Residual_ID,outID,(/N_x_ID,N_y_ID,N_g_ID,MGQD_Its_ID,RT_Its_ID,N_t_ID/),'MGQD_Residual','Double')
  CALL NF_DEF_VAR(MGQD_ResNorms_ID,outID,(/Norm_Types_ID,N_g_ID,MGQD_Its_ID,RT_Its_ID,N_t_ID/),'MGQD_ResNorms','Double')
...
!   run_type,kapE_dT,quad,enrgy_strc)
!
!   INTEGER,INTENT(OUT):: outID
!   INTEGER,INTENT(OUT):: N_x_ID, N_y_ID, N_m_ID, N_g_ID, N_t_ID, N_edgV_ID, N_edgH_ID
!   INTEGER,INTENT(OUT):: RT_Its_ID, MGQD_Its_ID, GQD_Its_ID, Norm_Types_ID, Boundaries_ID
